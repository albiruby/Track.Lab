    ...
    <div className="space-y-8">
      <div className="space-y-4">
        ...
        <p className="text-zinc-600 dark:text-zinc-400 max-w-2xl text-lg">
          Training zones calculator based on HR or Pace.
        </p>
      </div>
      ...
      <Card>
        ...
        <CardContent>
          <p className="text-zinc-600 dark:text-zinc-400 mb-6">
            ...
            but the frontend calculator UI has not been implemented yet. Track.Lab uses strict mathematical
            implementations—no fake data and no AI estimations are provided here.
          </p>
          <Link 
            href="/formulas" 
